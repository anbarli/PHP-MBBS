                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="content" name="content" rows="20" required><?php echo htmlspecialchars($_POST['content'] ?? $post['content']); ?></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="border rounded p-3 bg-light">
                                                <small class="text-muted">
                                                    ...
                                                    <strong>Son Düzenleme:</strong> <?php echo date('d.m.Y H:i', filemtime($postFile)); ?>
                                                </small>
                                            </div>
                                        </div>
                                    </div>
